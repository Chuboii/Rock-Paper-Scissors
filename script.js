let userR = document.querySelector(".u-rock")
let userP = document.querySelector(".u-paper")
let userS = document.querySelector(".u-scissors")
let rulesBtn = document.querySelector(".rules")
let ruleTab = document.querySelector(".rules-tab")
let bg = document.querySelector(".bg")
let alrt = document.querySelector(".alrt")
let continueBtn = document.querySelector(".cont")
let userScore = document.querySelector(".u-no")
let displaySelectionUser = document.querySelector(".use")
let board = document.querySelector(".board")
let displaySelectionComp = document.querySelector(".comp")
let computerScore = document.querySelector(".c-no")
let set =  document.querySelector(".set")
let setBg =  document.querySelector(".set-bg")
let left = document.querySelector(".set .contain .fa-arrow-left")
let right = document.querySelector(".set .contain .fa-arrow-right")
let startBtn = document.querySelector(".set button")
let setDisplay = document.querySelector(".set .contain .limit")
let winner = document.querySelector(".winner")
let w = document.querySelector(".w")
let playAgainBtn = document.querySelector(".play-again")
let setScoreBtn = document.querySelector(".set-score")

let count = 5
setDisplay.innerHTML = count
...
function generateComputerTurn() {
    ...
    let selectedKey = arr[random]
    let selectedName = Object.keys(selectedKey)
    return [selectedName, random]
}
...
function userTurn() {
 if (userCount === +setDisplay.innerHTML) {
    winner.classList.add("active")
    w.innerHTML =  `VICTORY! YOU'RE A CHAMPION!🥳🥳🥳`
 }
 else if (compCount === +setDisplay.innerHTML) {
    winner.classList.add("active")
    w.innerHTML = 'YOU WERE DEFEATED!😢'
 }
    ...
    let [selectedName, random] = generateComputerTurn()
   let selected = String(selectedName)
   let arrObjectName = arr[random]
   let arrKeys = String(Object.values(arrObjectName))
    let variableCKeys = Object.keys(variableC)
    let variableBKeys = Object.keys(variableB)
    let variableAKeys = Object.keys(variableA)
    let variableDKeys = Object.keys(variableD)

    if(random === +variableCKeys[0]){
       computerScore.innerHTML = compCount++
      board.innerHTML = "COMPUTER WINS!"
      displaySelectionComp.innerHTML = arrKeys
      displaySelectionComp.classList.add("cs")
    }
    else if(random === +variableCKeys[1]){
        if (selected === variableD[1]) {
      ...
      board.innerHTML = "YOU WINS 🥳"
      displaySelectionComp.innerHTML = arrKeys
      displaySelectionComp.classList.add("cs")
        }
    }
   else if (random === +variableCKeys[2]) {
     userScore.innerHTML = userCount++
    ...
    displaySelectionUser.innerHTML = userP.innerHTML
    displaySelectionUser.classList.add("p")
    ...
    userS.addEventListener('click', ()=>{
        ...
        let arrKeys = String(Object.values(arrObjectName))
         ...
         if(random === +variableBKeys[0]){
            if (selected === variableD[0]) {
                board.innerHTML = "DRAW "
                displaySelectionComp.innerHTML = arrKeys
                displaySelectionComp.classList.add("cs")
            }
         ...
         else if(random === +variableBKeys[1]){
            userScore.innerHTML = userCount++
           board.innerHTML = "YOU WIN! 🥳"
           displaySelectionComp.innerHTML = arrKeys
           displaySelectionComp.classList.add("cs")
        ...
        else if (random === +variableBKeys[2]) {
          computerScore.innerHTML = compCount++
          board.innerHTML = "COMPUTER WINS!"
        ...
        displaySelectionUser.innerHTML = userS.innerHTML
        displaySelectionUser.classList.add("s")
        alrt.classList.add("active")
    })
    ...
    userR.addEventListener('click', ()=>{
        ...
        let arrKeys = String(Object.values(arrObjectName))
         ...
         else if(random === +variableAKeys[1]){
            computerScore.innerHTML = compCount++
           board.innerHTML = "COMPUTER WINS!"
           displaySelectionComp.innerHTML = arrKeys
           displaySelectionComp.classList.add("cs")
        ...
        else if (random === +variableAKeys[2]) {
            if (selected === variableD[2]) {
                board.innerHTML = "DRAW "
                displaySelectionComp.innerHTML = arrKeys
                displaySelectionComp.classList.add("cs")
            }
        ...
        displaySelectionUser.innerHTML = userR.innerHTML
        displaySelectionUser.classList.add("r")
        alrt.classList.add("active")
...
function displayRules() {
    ruleTab.style.display = 'block'
    bg.style.display = 'block'
    setTimeout(() => {
        ruleTab.style.display = 'none'
